createcertificatesForOrg1() {
  ...
  echo
  fabric-ca-client register --caname ca.org1.example.com --id.name org1admin --id.secret org1adminpw --id.type admin --id.attrs "organization=doctor" --tls.certfiles ${PWD}/fabric-ca/org1/tls-cert.pem
  ...
  echo
  fabric-ca-client enroll -u https://org1admin:org1adminpw@localhost:7054 --caname ca.org1.example.com -M ${PWD}/../crypto-config/peerOrganizations/org1.example.com/users/Admin@org1.example.com/msp --enrollment.attrs "organization" --tls.certfiles ${PWD}/fabric-ca/org1/tls-cert.pem
...
createCertificatesForOrg2() {
  ...
  fabric-ca-client register --caname ca.org2.example.com --id.name org2admin --id.secret org2adminpw --id.type admin --id.attrs "organization=patient" --tls.certfiles ${PWD}/fabric-ca/org2/tls-cert.pem
  ...
  fabric-ca-client enroll -u https://org2admin:org2adminpw@localhost:8054 --caname ca.org2.example.com -M ${PWD}/../crypto-config/peerOrganizations/org2.example.com/users/Admin@org2.example.com/msp --enrollment.attrs "organization"  --tls.certfiles ${PWD}/fabric-ca/org2/tls-cert.pem
